...
const FALLBACK_SVG =
  "data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='800' height='500' viewBox='0 0 800 500'%3E%3Cdefs%3E%3ClinearGradient id='g' x1='0%25' y1='0%25' x2='100%25' y2='100%25'%3E%3Cstop offset='0%25' stop-color='%231a150a'/%3E%3Cstop offset='50%25' stop-color='%233a2d10'/%3E%3Cstop offset='100%25' stop-color='%231a150a'/%3E%3C/linearGradient%3E%3ClinearGradient id='gold' x1='0%25' y1='0%25' x2='100%25' y2='50%25'%3E%3Cstop offset='0%25' stop-color='%23D4AF37'/%3E%3Cstop offset='50%25' stop-color='%23FFF2A1'/%3E%3Cstop offset='100%25' stop-color='%23AA7D1E'/%3E%3C/linearGradient%3E%3C/defs%3E%3Crect width='800' height='500' fill='url(%23g)'/%3E%3Cpolygon points='250,330 310,210 490,210 550,330' fill='url(%23gold)' stroke='%23AA7D1E' stroke-width='3'/%3E%3Ctext x='400' y='270' font-family='serif' font-size='22' font-weight='bold' fill='%235A3D0A' text-anchor='middle'%3E999.9 FINE GOLD%3E%3C/text%3E%3Ctext x='400' y='300' font-family='sans-serif' font-size='14' fill='%235A3D0A' text-anchor='middle'%3EGOLD BAR SUPPLIERS AFRICA%3C/text%3E%3C/svg%3E";
...
export const SafeImage: React.FC<SafeImageProps> = ({
  ...
  return (
    <img
      src={currentSrc}
      alt={alt || 'Gold Bar Suppliers Africa'}
      className={className}
      onError={handleError}
      {...props}
    />
