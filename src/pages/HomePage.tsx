  ...
  return (
    <div>
      {/* ════════════════════════════════
           HERO
      ════════════════════════════════ */}
      <section className="hero" aria-label="Gold Bar Suppliers Africa hero">
        ...
        <div className="hero-inner">
          <div>
            ...
            <p className="hero-sub">
              Gold Bar Suppliers Ltd connects serious investors and businesses worldwide with certified <strong style={{ color: '#fff' }}>24K, 22K, and 18K gold bars</strong>, gold nuggets, gold dust, and dore bars — sourced directly from Africa's richest mines with full assay documentation and insured global delivery.
            </p>
        ...
        <div className="wrap">
          <div style={{ textAlign: 'center', marginBottom: '44px' }}>
            ...
            <p className="lead" style={{ margin: '14px auto 0', textAlign: 'center' }}>
              From pure investment bars to natural gold nuggets and raw gold dust — Gold Bar Suppliers Ltd covers every product category you need, direct from Africa's most productive mines.
            </p>
          </div>
      ...
      <section className="section section-fog" aria-labelledby="purity-title">
        <div className="wrap">
          <div style={{ textAlign: 'center', marginBottom: '44px' }}>
            ...
            <p className="lead" style={{ margin: '14px auto 0', textAlign: 'center' }}>
              Understanding gold purity is the foundation of every smart gold investment. Gold Bar Suppliers Ltd supplies all standard karat levels with certified assay documentation. Here is how each karat compares in June 2026.
            </p>
          </div>
        ...
        <div className="wrap">
          <div className="products-header">
            <div>
              ...
              <p className="lead" style={{ marginTop: '12px' }}>
                Gold Bar Suppliers Ltd sources from licensed mines and certified exporters across Africa's top gold-producing countries, giving you direct access to mine-proximate pricing.
              </p>
            </div>
        ...
        <div className="wrap">
          <div className="why-grid">
            <div className="why-img-stack">
              <img
                src="https://goldbarsuppliers.com/wp-content/uploads/2025/10/gold-3.webp?w=1200&ssl=1"
                alt="Certified gold bars Africa — Gold Bar Suppliers Ltd assay verification"
            ...
            <div>
              <div className="eyebrow">Why Gold Bar Suppliers Ltd</div>
        ...
        <div className="wrap">
          ...
          <div className="faq-grid">
            <div className="faq-item">
              ...
              <p className="faq-a">
                As of June 16, 2026, the 24K gold bar price is $139.39/gram ($4,339/oz, $139,390/kg) at LBMA spot. Gold Bar Suppliers Ltd prices at 1.5–3% above spot — approximately $141,410–$143,572 per kg all-in, including assay, documentation, and insured Brinks shipping. This is $5,000–$13,000 cheaper per kilogram than equivalent bars from US or UK retail dealers.
              </p>
            </div>
            <div className="faq-item">
              <div className="faq-q">Is it safe to buy gold bars from Africa?</div>
              <p className="faq-a">
                Yes — when purchasing from a licensed, documented dealer with independent assay certification, bank wire to a registered company account, and insured Brinks cargo. Gold Bar Suppliers Ltd meets all these standards. We conduct live video XRF assay before every payment and provide the complete documentation package for US, EU, and UAE customs clearance.
              </p>
            </div>
            <div className="faq-item">
              <div className="faq-q">Can I ship gold to the USA from Africa?</div>
              <p className="faq-a">
                Yes — investment-grade gold bullion (HS code 7108.12) enters the USA duty-free. All shipments must be declared at US CBP port of entry with full documentation including Certificate of Origin, commercial invoice, and assay certificate — all of which Gold Bar Suppliers Ltd provides.
              </p>
            </div>
            <div className="faq-item">
              <div className="faq-q">What is the difference between 24K, 22K, and 18K gold?</div>
              <p className="faq-a">
                24K (999 fineness) is 99.9% pure gold — best for investment and central bank reserves. 22K (916 fineness) is 91.7% gold — preferred for Middle Eastern and South Asian jewellery. 18K (750 fineness) is 75% gold — the most popular European jewellery karat. Gold Bar Suppliers Ltd supplies all three with certified assay documentation.
              </p>
            </div>
            <div className="faq-item">
              <div className="faq-q">What is the best place to buy gold bars in Africa?</div>
              <p className="faq-a">
                Ghana offers the lowest formal export levy (~1.5–2% via GoldBod). Uganda and Tanzania provide competitive mine-direct pricing. South Africa offers LBMA-accredited Rand Refinery bars at the highest global liquidity. Gold Bar Suppliers Ltd sources from all major African markets — advising buyers on the optimal country for their specific product and compliance requirements.
              </p>
            </div>
            <div className="faq-item">
              <div className="faq-q">Can I buy gold bars in Dubai from Africa?</div>
              <p className="faq-a">
                Yes. Dubai's DMCC is one of the world's largest gold trading hubs and a major re-export centre for African gold. Gold Bar Suppliers Ltd exports to UAE buyers with DMCC-compliant documentation including Certificate of Origin, assay certificates, and chain-of-custody records.
              </p>
            </div>
            <div className="faq-item">
              <div className="faq-q">How can I buy gold online in Canada from Africa?</div>
              <p className="faq-a">
                Canadian buyers can purchase African gold bars through Gold Bar Suppliers Ltd via bank wire transfer, with delivery by Brinks insured cargo from Africa to any Canadian city. All Canadian import requirements are fully met by our documentation package.
              </p>
            </div>
            <div className="faq-item">
              <div className="faq-q">What documents are required to buy gold from Africa?</div>
              <p className="faq-a">
                For import to most countries: a commercial invoice, Certificate of Origin, independent assay certificate, packing list, and AML/KYC documentation (passport/ID, proof of business). For US buyers: CBP import declaration. For EU buyers: OECD Due Diligence documentation if from conflict-affected areas. Gold Bar Suppliers Ltd provides all documentation.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section section-fog" aria-labelledby="intl-title">
        <div className="wrap">
          <div style={{ textAlign: 'center', marginBottom: '44px' }}>
            ...
            <p className="lead" style={{ margin: '14px auto 0', textAlign: 'center' }}>
              Gold Bar Suppliers Ltd ships certified African gold bars to international buyers in over 40 countries. Choose your destination for specific buying guides and local import requirements.
            </p>
          </div>
      ...
      <section className="cta-banner" aria-label="Buy gold bars from Africa — call to action">
        <div className="cta-inner">
          <div>
            ...
            <p>
              At today's LBMA spot of <strong style={{ color: 'var(--gold-lt)' }}>$139.39/gram ($139,390/kg)</strong>, African gold sourced through Gold Bar Suppliers Ltd saves you $5,000–$13,000 per kilogram versus US or UK retail. Our live XRF assay, Brinks shipping, and full OECD-compliant documentation make your purchase safe, fast, and fully bankable.
            </p>
