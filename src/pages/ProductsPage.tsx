      ...
      <div className="wrap">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: '48px', alignItems: 'start' }} className="content-sidebar-layout">
          ...
          <main style={{ minWidth: 0 }}>
            ...
            <p style={{ fontSize: '1rem', lineHeight: 1.8, color: 'var(--charcoal)', marginBottom: '16px' }}>
              At Gold Bar Suppliers Ltd., we specialize in providing authentic <Link to="/gold-bars-for-sale" style={{ color: 'var(--gold)', fontWeight: 600 }}>24K gold bars</Link> for sale, ranging from affordable 1 gram gold bars to institutional-grade 400 oz gold bar for sale options.
            </p>
            ...
            <p style={{ fontSize: '1rem', lineHeight: 1.8, color: 'var(--charcoal)', marginBottom: '16px' }}>
              At Gold Bar Suppliers Ltd., we pride ourselves on transparency, certification, and customer satisfaction. Our gold bars for sale come with assay certificates, hallmarks from recognized refineries, and insured shipping options.
            </p>
            ...
            <p style={{ fontSize: '1rem', lineHeight: 1.8, color: 'var(--charcoal)', marginBottom: '24px' }}>
              At Gold Bar Suppliers Ltd., we offer an extensive inventory, including everything from tiny 1 gram gold bars for sale to massive bars of gold for sale used by institutions.
            </p>
