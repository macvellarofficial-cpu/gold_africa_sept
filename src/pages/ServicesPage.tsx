  ...
  return (
    <div>
      {/* ═══════════════════════════════════════
           HERO
      ═══════════════════════════════════════════ */}
      <section className="hero" aria-label="Gold Africa Services">
        ...
        <div className="hero-inner">
          <div>
            ...
            <p className="hero-sub">
              Gold Africa provides the complete African gold service: certified{' '}
        ...
        <div className="wrap">
          ...
          <div style={{ marginTop: '36px', overflowX: 'auto' }}>
            ...
            <p style={{ marginTop: '10px', fontSize: '.75rem', color: 'var(--stone)' }}>
              *All prices based on LBMA spot $139.39/gram (June 16, 2026). Retail includes 1.5–3% Gold Africa premium.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="fsplit">
            ...
            <div>
              ...
              <p className="lead" style={{ margin: '14px 0 0' }}>
                Beyond refined bars, Gold Africa supplies the full spectrum of natural and semi-refined African gold — from collector-grade natural nuggets to artisanal gold dust and semi-refined dore bars for wholesale refiners.
              </p>
        ...
        <div className="wrap">
          <div style={{ marginBottom: '48px' }}>
            ...
            <p className="lead" style={{ marginTop: '14px', maxWidth: '660px' }}>
              The three compliance services that make every Gold Africa transaction bankable, legally importable, and fraud-proof. These are not optional add-ons — they are standard features of every order we process.
            </p>
          </div>
          ...
          <div className="srv-grid">
            <article className="srv-card" id="assay-detail">
              ...
              <div className="srv-body">
                ...
                <p>
                  Before any payment is requested, Gold Africa conducts a live WhatsApp or Zoom video XRF (X-ray fluorescence) purity test on your specific gold consignment — conducted by SGS Uganda, Bureau Veritas, or an equivalent DGSM-accredited laboratory. You watch 999.9 fineness confirmed in real time on screen.
                </p>
                <ul className="srv-list">
            ...
            <article className="srv-card" id="export">
              ...
              <div className="srv-body">
                ...
                <p>
                  Every international gold shipment from Uganda requires a specific set of legal documents to clear customs at origin and destination. Gold Africa prepares the complete documentation package — from DGSM export permit and Uganda Revenue Authority tax compliance to OECD Due Diligence records.
                </p>
                <ul className="srv-list">
            ...
            <article className="srv-card" id="shipping">
              ...
              <div className="srv-body">
                ...
                <p>
                  All gold shipments from Gold Africa travel with Brinks International or Malca-Amit insured armoured cargo — GPS-tracked from Entebbe International Airport (EBB) to your delivery address. Full declared-value insurance through Lloyd's of London or equivalent.
                </p>
                <ul className="srv-list">
          ...
          <div className="fsplit" style={{ gap: '56px' }}>
            <div>
              ...
              <p className="lead" style={{ margin: '16px 0 0' }}>
                For bulk buyers, institutional investors, and jewellery manufacturers who need consistent large-volume supply, Gold Africa offers two high-value services that deliver maximum cost efficiency: wholesale pricing and direct mine access.
              </p>
              ...
              <div className="feat-list" style={{ marginTop: '28px' }}>
                ...
                <div className="feat-item" id="sourcing">
                  ...
                  <div>
                    ...
                    <p>
                      For buyers who want maximum transparency and the deepest mine-proximate pricing, Gold Africa connects international buyers directly with Uganda's licensed artisanal mining cooperatives in Karamoja, Mubende, and Busia.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="wrap">
          <div style={{ textAlign: 'center', marginBottom: '60px' }}>
            ...
            <p className="lead-w" style={{ margin: '14px auto 0', textAlign: 'center', maxWidth: '580px' }}>
              Every Gold Africa transaction follows the same documented, fraud-proof, bank-compliant process — regardless of order size.
            </p>
          </div>
        ...
        <div className="wrap">
          ...
          <div className="faq-cols">
            <div className="faq-item">
              <div className="fq">What gold services does Gold Africa offer?</div>
