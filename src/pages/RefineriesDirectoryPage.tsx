      ...
      <div className="wrap">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: '48px', alignItems: 'start' }} className="content-sidebar-layout">
          <main style={{ minWidth: 0 }}>
            ...
            <p style={{ fontSize: '1rem', lineHeight: 1.8, color: 'var(--charcoal)', marginBottom: '16px' }}>
              Gold Africa works directly with accredited refiners and licensed dealers in Entebbe to facilitate transparent, documented purchases of certified African gold bars. Every bar comes with independent SGS / Bureau Veritas assay certificates, Certificate of Origin, and insured Brinks cargo logistics.
            </p>
